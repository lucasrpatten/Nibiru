...
function App() {
  ...
  const buttonInside = 'py-4 px-14 rounded-xl hover:bg-dark-blue/100 transition duration-300 bg-dark-blue/0'
  return (
    <motion.div
      initial={{ opacity:0 }}
      animate={{ opacity:1 }}
