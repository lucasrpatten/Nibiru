...
function Footer() {
    const button = "w-full md:w-auto mt-10 md:m-10 p-1 font-bold rounded-full bg-gradient-to-r from-teal via-blue to-purple"
    const buttonInside = 'py-4 px-10 rounded-full hover:bg-dark-blue/100 transition duration-300 bg-dark-blue/0'
    return (
      <>
            ...
            <div className='mt-10 w-full lg:flex gap-10 justify-center text-center'>
                ...
                <div className="mt-20 lg:mt-0 lg:w-1/4 text-white h-full">
                    ...
                    <form className='flex flex-col' action="/action_page.php">
                        ...
                        <input className='py-4 px-10 w-full md:w-auto mt-10 p-1 font-bold rounded-full' type="text" id="fname" name="fname"/>
                ...
                <div className="text-center lg:text-left mt-24 text-white lg:flex justify-around items-center pt-5">
                    <div className='mt-5 lg:mt-0 md:flex gap-5 text-white lg:w-1/2 h-full justify-around'>
                        <Link className="hover:text-light-gray duration-200" to='/'>Home</Link>
                        <Link className="hover:text-light-gray duration-200" to='/Prices'>Pricing</Link>
                        <Link className="hover:text-light-gray duration-200" to='/'>Training</Link>
                        <div className="text-center">
                            <p>Company <FontAwesomeIcon icon={faChevronDown}/> </p>
                            <ul className="text-light-gray mt-2">
                                <li className="hover:text-teal duration-200"><Link to='/'>About Us</Link></li>
                                <li className="hover:text-teal duration-200"><Link to='/'>Customer Service </Link></li>
                                <li className="hover:text-teal duration-200"><Link to='/'>TSA Documentation </Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
