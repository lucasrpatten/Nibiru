...
const Main = (props) => {
  return (
    <div className="gap-10 p-8 mb-24 lg:flex items-center justify-center text-center text-white">
      <div>
        <h2 className="mt-10 text-center text-teal text-2xl">
          {" "}
          {props.training}{" "}
        </h2>
        <div className=" flex gap-10 flex-row flex flex-col items-center justify-center">
          <p className="mt-4">
            {" "}
            <span className="font-bold"> Purpose: </span> {props.purpose}{" "}
          </p>
          ...
          <p className="my-4">
            {" "}
            <span className="font-bold"> Delivery mode: </span> {props.delivery}{" "}
          </p>
          <p className="mb-4">
            {" "}
            <span className="font-bold"> Evaluation procedure: </span>{" "}
            {props.evaluation}{" "}
          </p>
        </div>
      </div>
...
const Training = () => {
  return (
    <motion.div
      ...
      className="px-5"
    >
      <div className="px-5 pt-36"></div>
      <h1 className="mb-14 text-center text-white lg:text-7xl text-5xl font-bold">
        Training Breakdown
      </h1>
      <Main
