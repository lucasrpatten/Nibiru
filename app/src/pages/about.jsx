  ...
  return (
    ...
    >
      <div className="p-5 py-36">
        <Title />
        <div className="px-24 mt-24 md:flex w-full justify-center gap-10 h-auto">
          <img className="w-full md:w-1/2 rounded-xl" src={ship}/>
        ...
        <div className="px-24 mt-24 md:flex w-full justify-center gap-10 h-auto">
          ...
          <img className="mt-24 md:mt-0 w-full md:w-1/2 rounded-xl" src={building}/>
        </div>
      </div>
    </motion.div>
  );
